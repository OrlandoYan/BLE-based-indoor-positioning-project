...
"E:\通信资料\USYD Postgraduate Project\Thesis\IAR-ARM\Workbench\common\bin\cspybat" -f "E:\通信资料\USYD Postgraduate Project\Thesis\en.X-CUBE-BLE1\STM32CubeExpansion_BLE1_V3.0.0\Projects\Multi\Applications\SampleAppThT\EWARM\STM32L476RG-Nucleo\settings\SampleAppThT.SampleApp_SERVER.general.xcl" "--debug_file=%~1" --backend -f "E:\通信资料\USYD Postgraduate Project\Thesis\en.X-CUBE-BLE1\STM32CubeExpansion_BLE1_V3.0.0\Projects\Multi\Applications\SampleAppThT\EWARM\STM32L476RG-Nucleo\settings\SampleAppThT.SampleApp_SERVER.driver.xcl" 
